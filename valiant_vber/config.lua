...
Config.Zones = {
	...
	VehicleSpawnPoint = {
		Pos     = {x = -110.6012, y = -602.9449, z = 35.97402},
		Size    = {x = 1.5, y = 1.5, z = 1.0},
		Type    = -1, Rotate = false,
		Heading = 250.90943908691
	},

	VehicleDeleter = {
		Pos   = {x = -105.4, y = -611.36, z = 35.08},
	...
	vberActions = {
		Pos   = {x = -138.56, y = -633.88, z = 168.84},
		Size  = {x = 1.0, y = 1.0, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Type  = 20, Rotate = true
	},
