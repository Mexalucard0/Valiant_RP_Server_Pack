Locales['en'] = {
  ...
  ['only_vber'] = 'you can only store vbers.',

  ['taking_service'] = 'taking service: vber/Uber',
  ...
  ['must_in_vber'] = 'you must be in a ~y~vber~s~ to start the mission',
