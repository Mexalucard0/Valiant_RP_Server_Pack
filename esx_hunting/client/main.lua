...
local AnimalPositions = {
	...
	{ x = -903.92, y = 4825.08, z = 304.76 },
	{ x = -565.76, y = 4858.16, z = 173.24 },
	{ x = -311.44, y = 4684.44, z = 248.44 },
	{ x = -713.64, y = 4769.32, z = 222.64 },
	{ x = -156.08, y = 4907.56, z = 340.64 },
	{ x = -110.72, y = 4620.4, z = 123.84 },
	{ x = -228.84, y = 4142.68, z = 41.04 },
	{ x = -567.44, y = 3971.92, z = 107.12 },
	{ x = -1030.16, y = 4164.84, z = 119.96 },
	{ x = -1427.56, y = 4194.08, z = 48.0 },		
}
...
function StartHuntingSession()
	...
	if OnGoingHuntSession then
		...
		HuntCar = CreateVehicle(GetHashKey('bfinjection'), Positions['SpawnATV'].x, Positions['SpawnATV'].y, Positions['SpawnATV'].z, 169.79, true, false)
