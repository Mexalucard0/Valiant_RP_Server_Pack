...
Config.Zones = {
	...
	HellhoundsActions = {
		Pos   = { x = -2679.64, y = 1310.96, z = 147.16 },
	...
	Craft = {
		Pos   = { x = -2683.92, y = 1328.48, z = 164.92 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 27
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -2659.914, y = 1306.0, z = 146.8795 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = -2668.628, y = 1304.836, z = 146.8797 },
