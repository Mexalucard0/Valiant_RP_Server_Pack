...
if Config.MaxInService ~= -1 then
	TriggerEvent('esx_service:activateService', 'mechanicc', Config.MaxInService)
end

TriggerEvent('gcphone:registerNumber', 'mechanicc', _U('mechanicc_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'mechanicc', 'mechanicc', 'society_mechanicc', 'society_mechanicc', 'society_mechanicc', {type = 'private'})
...
AddEventHandler('esx_mechanicjob:onNPCJobMissionCompleted', function()
	...
	TriggerEvent('esx_addonaccount:getSharedAccount', 'society_mechanicc', function(account)
...
AddEventHandler('esx_mechanicjob:getStockItem', function(itemName, count)
	...
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_mechanicc', function(inventory)
