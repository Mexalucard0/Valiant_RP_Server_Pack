...
RegisterNetEvent("hound-blackmarket:eventHandler")
AddEventHandler("hound-blackmarket:eventHandler", function(response, eventData)
...
RegisterNetEvent("hound-blackmarket:bpvest")
AddEventHandler("hound-blackmarket:bpvest", function()
