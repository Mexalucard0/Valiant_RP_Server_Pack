------------------------------------------
--	iEnsomatic valiant_vehiclefailure  --
------------------------------------------
--
...
--
--	https://github.com/iEns/valiant_vehiclefailure
--
...
cfg = {
	...
	limpModeMultiplier = 0.2,					-- The torque multiplier to use when vehicle is limping. Sane values are 0.05 to 0.25
