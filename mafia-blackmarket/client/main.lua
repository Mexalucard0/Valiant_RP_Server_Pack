...
RegisterNetEvent("mafia-blackmarket:eventHandler")
AddEventHandler("mafia-blackmarket:eventHandler", function(response, eventData)
...
RegisterNetEvent("mafia-blackmarket:bpvest")
AddEventHandler("mafia-blackmarket:bpvest", function()
