...
Config.objects = {
	...
	locations = {
		...
		[11] = {object="v_med_bed1", verticalOffsetX=0.0, verticalOffsetY=-0.1, verticalOffsetZ=-1.5, direction=180.0, bed=true},
		[12] = {object="v_med_cor_medstool", verticalOffsetX=0.0, verticalOffsetY=-0.1, verticalOffsetZ=-0.6, direction=180.0, bed=false},
		[13] = {object="V_Res_M_DineChair", verticalOffsetX=0.0, verticalOffsetY=-0.1, verticalOffsetZ=-1.5, direction=180.0, bed=false}					
	}
}