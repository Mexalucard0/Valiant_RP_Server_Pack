...
RegisterNetEvent("Societyweed-blackmarket:eventHandler")
AddEventHandler("Societyweed-blackmarket:eventHandler", function(response, eventData)
...
RegisterNetEvent("Societyweed-blackmarket:bpvest")
AddEventHandler("Societyweed-blackmarket:bpvest", function()
